    ...
    <div class="carousel-form">
            ...
            <div class="login-form">
                ...
                <div class="social-auth">
                    ...
                    <button class="social-button" @click="toggleInputMode">
                        <img :src="inputMode === 'email' ? '../../assets/icons/phone.svg' : '../../assets/icons/email.svg'" alt="" class="icon"> 
        ...
        <div v-if="step === 2" class="form-step">
            <div class="form2">
                ...
                <h2 class="mb-4">Enter password</h2>
                ...
                <div class="bottom">
                    ...
                    <p class="right mt-1">Forgot Password?</p>
...
const nextStep = () => {
    if (inputMode.value === 'email' && email.value && agreed.value) {
        step.value = 2;
    } else if (inputMode.value === 'phone' && phone.value && agreed.value) {
        step.value = 2;
    }
};
...
const validatePassword = () => {
    if (password.value.length < 8) {
        ...
        // Here you would typically handle login submission
